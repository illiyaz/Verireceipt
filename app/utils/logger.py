...
def _decision_to_row(file_path: str, decision: ReceiptDecision) -> Dict[str, Any]:
    ...
    row: Dict[str, Any] = {
        ...
        "policy_notes": decision.policy_notes or "",
        "extraction_confidence_score": decision.extraction_confidence_score or 0.0,
        "extraction_confidence_level": decision.extraction_confidence_level or "",
        "normalized_total": decision.normalized_total or 0.0,
